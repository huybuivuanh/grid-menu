...
import { trimFont } from "../utils/FontProcessing";
...
const GridList300 = () => {
  ...
  useEffect(() => {
    setFontSizes(JSON.parse(localStorage.getItem("fontSizes300")));
  }, []);
  ...
  const StartTrial = () => {
    ...
    targetFont = Math.floor(Math.random() * 300); // get a random value from 0 to 299 (300 values)
